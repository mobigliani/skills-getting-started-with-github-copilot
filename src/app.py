...
def signup_for_activity(activity_name: str, email: EmailQuery):
...
def unregister_from_activity(activity_name: str, email: EmailQuery):
    ...
    # Check if student is currently signed up
